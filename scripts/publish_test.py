...
def validate_package_metadata():
    ...
    required_files = ["README.md", "pyproject.toml", "src/mcp_clipboard_server/__init__.py"]
    ...
    if f'__version__ = "{version}"' not in init_content:
        print(f"Warning: Version mismatch in __init__.py")
...
def main():
    ...
    print(f"Package successfully published and verified on TestPyPI!")
    print(f"Install with:")
    print(f"pip install --index-url https://test.pypi.org/simple/ --extra-index-url https://pypi.org/simple/ mcp-clipboard-server=={get_package_version()}")
