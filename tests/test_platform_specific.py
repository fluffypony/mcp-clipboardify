...
from mcp_clipboard_server.clipboard import (
    get_clipboard, set_clipboard, ClipboardError, 
    _get_platform_info, _get_platform_guidance
)
    ...
    def test_get_platform_info_wsl(self):
        ...
        with patch('platform.system', return_value='Linux'):
            with patch('os.path.exists', return_value=True):
                with patch('builtins.open', unittest.mock.mock_open(read_data='Microsoft Linux')):
                    result = _get_platform_info()
...
class TestPlatformGuidance:
    ...
    def test_linux_xclip_guidance(self):
        ...
        with patch('mcp_clipboard_server.clipboard._get_platform_info', return_value='Linux'):
    ...
    def test_linux_headless_guidance(self):
        ...
        with patch('mcp_clipboard_server.clipboard._get_platform_info', return_value='Linux (headless)'):
    ...
    def test_wsl_guidance(self):
        ...
        with patch('mcp_clipboard_server.clipboard._get_platform_info', return_value='WSL (Windows Subsystem for Linux)'):
    ...
    def test_macos_guidance(self):
        ...
        with patch('mcp_clipboard_server.clipboard._get_platform_info', return_value='macOS'):
    ...
    def test_windows_guidance(self):
        ...
        with patch('mcp_clipboard_server.clipboard._get_platform_info', return_value='Windows'):
