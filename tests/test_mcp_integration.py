...
class MCPIntegrationTest(unittest.TestCase):
    ...
    async def send_notification(self, writer: asyncio.StreamWriter,
    ...
    async def test_full_handshake(self):
        ...
        await self.send_request(writer, "initialize", {
            "protocolVersion": "1.0",
            "clientInfo": {
                "name": "test-client",
                "version": "1.0.0"
...
MCPIntegrationTest.test_full_handshake = run_async_test(MCPIntegrationTest.test_full_handshake)
MCPIntegrationTest.test_clipboard_operations = run_async_test(MCPIntegrationTest.test_clipboard_operations)
MCPIntegrationTest.test_unicode_content = run_async_test(MCPIntegrationTest.test_unicode_content)
MCPIntegrationTest.test_error_scenarios = run_async_test(MCPIntegrationTest.test_error_scenarios)
MCPIntegrationTest.test_malformed_json = run_async_test(MCPIntegrationTest.test_malformed_json)
MCPIntegrationTest.test_ping_notification = run_async_test(MCPIntegrationTest.test_ping_notification)
MCPIntegrationTest.test_large_content = run_async_test(MCPIntegrationTest.test_large_content)
MCPIntegrationTest.test_rapid_requests = run_async_test(MCPIntegrationTest.test_rapid_requests)
